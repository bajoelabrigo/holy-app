  ...
  const renderButton = () => {
    ...
    switch (connectionStatus?.data?.status) {
      ...
      default:
        return (
          <button
            className="px-3 py-1 rounded-full text-sm border border-primary  hover:bg-primary hover:text-white transition-colors duration-200 flex items-center"
    ...
    <div className="flex items-center justify-between mb-4">
      ...
      >
        <img
          ...
          alt={user.name}
          className="w-12 h-12 rounded-full mr-3 overflow-hidden object-cover"
        />
        <div>
